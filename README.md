# Azo Financas Releases

Repositorio publico usado somente para publicar instaladores e metadados de atualizacao do Azo Financas.
...
```text
https://github.com/samuellgc/azo-financas-releases/releases/latest/download/latest.json
```
